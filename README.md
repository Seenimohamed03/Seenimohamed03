...
<h3 align="center">🚀 Data Analyst | AI Enththusiast </h3>

Skilled in SQL,PowerBI,Excel and Python. I have built intereactive dashboards to analyse and visualize the data in visual form. I enjoy to generate the data to analyse the Business Insights and Decision making. My work is to turn raw data into Meaningfull insights to analyze the customer behaviour.
